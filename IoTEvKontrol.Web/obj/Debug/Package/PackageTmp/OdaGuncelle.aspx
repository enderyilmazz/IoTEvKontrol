<%@ Page Title="" Language="C#" MasterPageFile="~/Anasayfa.Master" AutoEventWireup="true" CodeBehind="OdaGuncelle.aspx.cs" Inherits="IoTEvKontrol.Web.OdaGuncelle" %>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" AssociatedControlID="MevcutCihaz">Cihaz</asp:Label>
                                                <asp:DropDownList CssClass="form-control" ID="MevcutCihaz" runat="server" Enabled="false">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" AssociatedControlID="CihazListe">Yeni Cihaz</asp:Label>
